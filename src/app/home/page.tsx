    ...
    return (
        <section className="flex flex-col lg:flex-row min-h-screen">
            ...
            <div className="bg-gradient-to-r from-teal-500 to-green-400 lg:w-[80rem] pl-10 items-center justify-center">
                ...
                <p className="text-xl md:text-xl sm:ml-24">Karachi, Pakistan</p>
                <Link href="/contact">
                    <button className="mt-10 md:text-lg border-2 w-24 md:w-32 p-2 active:opacity-5 sm:ml-24">Hire Me</button>
                </Link>
